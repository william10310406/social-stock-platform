...
def downgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('nid_enc', postgresql.BYTEA(), autoincrement=False, nullable=True))
        ...
        batch_op.add_column(sa.Column('phone_enc', postgresql.BYTEA(), autoincrement=False, nullable=True))
