...
"""
INFO 層級功能測試
測試資安架構 info_0、info_1、info_2 層級的各項功能
"""
...
def test_info_0_utils():
    """測試 INFO-0 層級：工具函數"""
    print("🔍 測試 INFO-0 層級：安全工具...")
    ...
    try:
        ...
        print(f"❌ INFO-0 工具測試失敗: {e}")
        return False


def test_info_0_exceptions():
    """測試 INFO-0 層級：例外處理"""
    print("🔍 測試 INFO-0 層級：安全例外...")
    
    try:
        from security.levels.info.info_0.security_exceptions import (
        ...
        print(f"❌ INFO-0 例外測試失敗: {e}")
        return False


def test_info_1_security_logger():
    """測試 INFO-1 層級：安全日誌"""
    print("🔍 測試 INFO-1 層級：安全日誌系統...")
    
    try:
        from security.levels.info.info_1.security_logger import (
        ...
        print(f"❌ INFO-1 日誌測試失敗: {e}")
        return False


def test_info_2_config_manager():
    """測試 INFO-2 層級：配置管理"""
    print("🔍 測試 INFO-2 層級：配置管理系統...")
    
    try:
        from security.levels.info.info_2.config_manager import (
        ...
        print("✅ INFO-2 配置管理測試通過")
        return True
        
    except Exception as e:
        print(f"❌ INFO-2 配置管理測試失敗: {e}")
        return False


def test_info_2_security_monitoring():
    """測試 INFO-2 層級：安全監控"""
    print("🔍 測試 INFO-2 層級：安全監控系統...")
    
    try:
        from security.levels.info.info_2.security_monitoring import (
        ...
        print("✅ INFO-2 安全監控測試通過")
        return True
        
    except Exception as e:
        print(f"❌ INFO-2 安全監控測試失敗: {e}")
        return False
...
def test_dependencies():
    ...
    try:
        ...
        from security.levels.info.info_0 import security_utils
        from security.levels.info.info_0 import security_exceptions
        
        # 測試 INFO-1 依賴 INFO-0
        from security.levels.info.info_1 import security_logger
        
        # 測試 INFO-2 依賴 INFO-0 和 INFO-1
        from security.levels.info.info_2 import config_manager
        from security.levels.info.info_2 import security_monitoring
...
def test_integration():
    ...
    try:
        # 整合測試：配置 + 日誌 + 監控
        from security.levels.info.info_1.security_logger import SecurityLogger
        from security.levels.info.info_2.config_manager import ConfigManager
        from security.levels.info.info_2.security_monitoring import SecurityMonitoring
...
def main():
    ...
    tests = [
        ...
        ("INFO-0 工具", test_info_0_utils),
        ("INFO-0 例外", test_info_0_exceptions),
        ("INFO-1 日誌", test_info_1_security_logger),
        ("INFO-2 配置", test_info_2_config_manager),
        ("INFO-2 監控", test_info_2_security_monitoring),
